            ...
            <div class="card-body border-top">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4 mb-3">
                        ...
                        <select id="field_type" class="form-control required" error="Field Type">
                            <option value="">Pilih Field Type</option>
                            <option value="text" {{ isset($data->field_type) && $data->field_type == 'text' ? 'selected'
                                : '' }}>text</option>
                            <option value="textarea" {{ isset($data->field_type) && $data->field_type == 'textarea' ?
                                'selected' : '' }}>textarea</option>
                            <option value="date" {{ isset($data->field_type) && $data->field_type == 'date' ? 'selected'
                                : '' }}>date</option>
                            <option value="number" {{ isset($data->field_type) && $data->field_type == 'number' ?
