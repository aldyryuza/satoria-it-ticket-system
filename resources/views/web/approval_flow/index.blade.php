    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @canAccess('master/approval-flow','create')
                <button class="btn btn-primary" onclick="ApprovalFlow.add()">Tambah Data <i
                        class="bx bx-plus"></i></button>
                @endcanAccess

                @canAccess('master/approval-flow','update')
                <input type="hidden" name="update" id="update" value="1">
                @endcanAccess

                @canAccess('master/approval-flow','delete')
